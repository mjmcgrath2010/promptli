...
var _jsxFileName = "/app/lib/with-redux-store.js";
...
var _isServer = __webpack_require__(/*! ../utils/is-server */ "./node_modules/next-i18next/dist/commonjs/utils/is-server.js");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _sentry_browser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @sentry/browser */ "@sentry/browser");
...
/* harmony import */ var _lib_i18n__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../lib/i18n */ "./lib/i18n.js");
...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_1___default.a {
  ...
  render() {
    ...
    return __jsx(react_redux__WEBPACK_IMPORTED_MODULE_5__["Provider"], {
      ...
      theme: _lib_theme__WEBPACK_IMPORTED_MODULE_9__["default"],
      __source: {
        fileName: _jsxFileName,
        lineNumber: 31
      },
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_lib_with_redux_store__WEBPACK_IMPORTED_MODULE_4__["default"])(Object(_lib_i18n__WEBPACK_IMPORTED_MODULE_10__["appWithTranslation"])(MyApp)));

/***/ }),

/***/ "./reducers/admin/index.js":
/*!*********************************!*\
  !*** ./reducers/admin/index.js ***!
  \*********************************/
/*! exports provided: default */
...
const admin = (state = initialState, action) => {
  switch (action.type) {
    case _constants_index__WEBPACK_IMPORTED_MODULE_1__["adminActionTypes"].INIT_ADMIN:
...
const dashboard = (state = initialState, action) => {
  switch (action.type) {
    case _constants_index__WEBPACK_IMPORTED_MODULE_1__["dashboardActionTypes"].INIT_DASHBOARD_SUCCESS:
      const activeAccount = action.payload.profile.accounts[0];
      return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, {
        account: activeAccount
      }, action.payload);

    case _constants_index__WEBPACK_IMPORTED_MODULE_1__["loginActionTypes"].LOGOUT_SUCCESS:
    case _constants_index__WEBPACK_IMPORTED_MODULE_1__["dashboardActionTypes"].CREATE_PACKAGE_SUCCESS:
...
/*!***************************!*\
  !*** ./reducers/index.js ***!
  \***************************/
/*! exports provided: dashboard, admin, auth */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dashboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard */ "./reducers/dashboard/index.js");
...
/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin */ "./reducers/admin/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "admin", function() { return _admin__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login */ "./reducers/login.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "auth", function() { return _login__WEBPACK_IMPORTED_MODULE_2__["default"]; });
...
const auth = (state = initialState, action) => {
  switch (action.type) {
    case _constants_index__WEBPACK_IMPORTED_MODULE_2__["loginActionTypes"].LOGIN_REQUEST:
      return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, state, {
        loading: true
      });

    case _constants_index__WEBPACK_IMPORTED_MODULE_2__["loginActionTypes"].LOGIN_SUCCESS:
      return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, state, action.payload, {
        isLoggedIn: true
      });

    case _constants_index__WEBPACK_IMPORTED_MODULE_2__["loginActionTypes"].LOGIN_FAILURE:
      return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, state, {
        error: action.payload
      });

    case _constants_index__WEBPACK_IMPORTED_MODULE_2__["loginActionTypes"].AUTH_SUCCESS:
      const {
        payload
      } = action;
      return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, payload);

    case _constants_index__WEBPACK_IMPORTED_MODULE_2__["loginActionTypes"].LOGOUT_SUCCESS:
      return initialState;
...
/*!******************!*\
  !*** ./store.js ***!
  \******************/
/*! exports provided: initialState, initializeStore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const rootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  dashboard: _reducers_index__WEBPACK_IMPORTED_MODULE_4__["dashboard"],
  admin: _reducers_index__WEBPACK_IMPORTED_MODULE_4__["admin"],
  auth: _reducers_index__WEBPACK_IMPORTED_MODULE_4__["auth"]
});
function initializeStore() {
  ...
  if (isClient) {
    ...
    store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(persistReducer(persistConfig, rootReducer), initialState, Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_3__["composeWithDevTools"])(Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_1___default.a)));
    store.__PERSISTOR = Object(redux_persist__WEBPACK_IMPORTED_MODULE_2__["persistStore"])(store);
  } else {
    store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(rootReducer, initialState, Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_1___default.a));
  }
