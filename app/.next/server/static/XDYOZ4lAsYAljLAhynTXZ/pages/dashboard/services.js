...
// CONCATENATED MODULE: ./components/dashboard/CreateService.js
...
class CreateService_CreateService extends external_react_["Component"] {
  constructor(props) {
    super(props);
    ...
    Object(defineProperty["a" /* default */])(this, "onSubmit", () => {
      ...
      createService(Object(objectSpread["a" /* default */])({}, this.state, {
        accountId
      }));
    });
...
CreateService_CreateService.defaultProps = {
  onSubmit: () => {}
};
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    createService: payload => dispatch(actions["a" /* dashboardActions */].createServiceRequest(payload))
  };
};

/* harmony default export */ var dashboard_CreateService = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CreateService_CreateService));
...
// CONCATENATED MODULE: ./pages/dashboard/services.js
...
class services_Services extends external_react_["Component"] {
  ...
  render() {
    return services_jsx(layouts["a" /* default */], null, services_jsx(head_default.a, null, services_jsx("title", null, "Services | Promptli")), services_jsx(FullScreenModal["a" /* default */], {
      title: "Add a Service",
      btnText: "Add a Service"
    }, services_jsx(dashboard_CreateService, null)), services_jsx(DataTable["a" /* default */], {
      resource: "services",
...
Object(defineProperty["a" /* default */])(services_Services, "defaultProps", {});

const services_mapStateToProps = state => {
  return {
    dashboard: state.dashboard
  };
};

const services_mapDispatchToProps = dispactch => {
  return {
    dispatch: action => dispatch(action)
  };
};

/* harmony default export */ var services = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(services_mapStateToProps, services_mapDispatchToProps)(Object(withAuth["a" /* default */])(services_Services)));
...
module.exports = __webpack_require__("48ao");
