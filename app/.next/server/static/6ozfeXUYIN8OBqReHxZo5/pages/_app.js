...
// CONCATENATED MODULE: ./reducers/dashboard/index.js
...
const dashboard = (state = dashboard_initialState, action) => {
  switch (action.type) {
    case constants["b" /* dashboardActionTypes */].INIT_DASHBOARD_SUCCESS:
      const activeAccount = action.payload.profile.accounts[0];
      return Object(objectSpread["a" /* default */])({}, state, {
        account: activeAccount
      }, action.payload);

    case constants["c" /* loginActionTypes */].LOGOUT_SUCCESS:
    case constants["b" /* dashboardActionTypes */].CREATE_PACKAGE_SUCCESS:
      return Object(objectSpread["a" /* default */])({}, state, action.payload);
      return dashboard_initialState;
...
/* harmony default export */ var reducers_dashboard = (dashboard);
// EXTERNAL MODULE: ./node_modules/@babel/runtime-corejs2/core-js/object/assign.js
var object_assign = __webpack_require__("UXZV");
var assign_default = /*#__PURE__*/__webpack_require__.n(object_assign);

// CONCATENATED MODULE: ./reducers/admin/index.js
...
const admin = (state = admin_initialState, action) => {
  switch (action.type) {
    case constants["a" /* adminActionTypes */].INIT_ADMIN:
...
/* harmony default export */ var reducers_admin = (admin);
// CONCATENATED MODULE: ./reducers/login.js
...
const auth = (state = login_initialState, action) => {
  switch (action.type) {
    case constants["c" /* loginActionTypes */].LOGIN_REQUEST:
      return assign_default()({}, state, {
        loading: true
      });

    case constants["c" /* loginActionTypes */].LOGIN_SUCCESS:
      return assign_default()({}, state, action.payload, {
        isLoggedIn: true
      });

    case constants["c" /* loginActionTypes */].LOGIN_FAILURE:
      return assign_default()({}, state, {
        error: action.payload
      });

    case constants["c" /* loginActionTypes */].AUTH_SUCCESS:
      const {
        payload
      } = action;
      return Object(objectSpread["a" /* default */])({}, state, payload);

    case constants["c" /* loginActionTypes */].LOGOUT_SUCCESS:
      return login_initialState;
...
/* harmony default export */ var login = (auth);
...
function initializeStore() {
  ...
  if (isClient) {
    ...
    store = Object(external_redux_["createStore"])(persistReducer(persistConfig, rootReducer), store_initialState, Object(external_redux_devtools_extension_["composeWithDevTools"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a)));
    store.__PERSISTOR = Object(external_redux_persist_["persistStore"])(store);
  } else {
    store = Object(external_redux_["createStore"])(rootReducer, store_initialState, Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a));
  }
...
var theme = __webpack_require__("PTv9");

// EXTERNAL MODULE: ./lib/i18n.js
var i18n = __webpack_require__("+ZiV");
...
class _app_MyApp extends app_default.a {
  ...
  render() {
    ...
    }, _app_jsx(CssBaseline_default.a, null), _app_jsx(Component, pageProps))));
  }

}

/* harmony default export */ var _app = __webpack_exports__["default"] = (with_redux_store(Object(i18n["appWithTranslation"])(_app_MyApp)));
