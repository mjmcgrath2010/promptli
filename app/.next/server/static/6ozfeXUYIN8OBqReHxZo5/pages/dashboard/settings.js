...
// CONCATENATED MODULE: ./components/common/GoogleAuthComponent.js
...
const GoogleAuthComponent = props => {
  ...
  return __jsx(external_react_["Fragment"], null, __jsx(CommonButton["a" /* default */], {
    text: "Connect Google",
...
const mapDispatchToProps = dispatch => ({
  dispatch,
  connectGoogleAccount: payload => dispatch(actions["a" /* dashboardActions */].connectGoogleAccount(payload))
});

/* harmony default export */ var common_GoogleAuthComponent = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(GoogleAuthComponent));
// CONCATENATED MODULE: ./pages/dashboard/settings.js
...
class settings_Settings extends external_react_["Component"] {
  ...
  render() {
    return settings_jsx(layouts["a" /* default */], null, settings_jsx(head_default.a, null, settings_jsx("title", null, "Settings | Promptli")), settings_jsx("div", null, "Settings"), settings_jsx(common_GoogleAuthComponent, null));
  }

}

Object(defineProperty["a" /* default */])(settings_Settings, "defaultProps", {});
...
const settings_mapDispatchToProps = dispactch => {
  return {
    dispatch: action => dispatch(action)
  };
};

/* harmony default export */ var settings = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(settings_mapStateToProps, settings_mapDispatchToProps)(Object(withAuth["a" /* default */])(settings_Settings)));
...
module.exports = __webpack_require__("+fJr");
