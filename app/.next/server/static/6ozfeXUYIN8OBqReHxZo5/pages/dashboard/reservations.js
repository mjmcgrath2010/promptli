...
module.exports = __webpack_require__("RHJ1");
...
// CONCATENATED MODULE: ./components/common/Calendar/CalendarTile.js
var __jsx = external_react_default.a.createElement;


const Container = external_styled_components_default.a.div.withConfig({
  displayName: "CalendarTile__Container",
  componentId: "w2iaqc-0"
})(["height:112px;flex:0 0 calc(14% - 3px);width:100%;margin:3px;border:0.5px solid rgba(0,0,0,0.1);padding:5px 10px;border-radius:4px;box-shadow:1px 2px 4px rgba(0,0,0,0.2);cursor:pointer;"]);
...
/* harmony default export */ var Calendar_CalendarTile = (CalendarTile);
// EXTERNAL MODULE: ./components/common/CommonButton.js + 2 modules
var CommonButton = __webpack_require__("TGPV");

// CONCATENATED MODULE: ./components/common/Calendar/index.js
...
const CalendarContainer = external_styled_components_default.a.div.withConfig({
...
const DayHeading = external_styled_components_default.a.div.withConfig({
  displayName: "Calendar__DayHeading",
  componentId: "pwm3t8-1"
})(["width:14%;font-size:14px;text-align:center;align-content:baseline;"]);
const HeaderContainer = external_styled_components_default()(CalendarContainer).withConfig({
  displayName: "Calendar__HeaderContainer",
  componentId: "pwm3t8-2"
})(["justify-content:space-evenly;margin-bottom:6px;"]);
const HeaderItem = external_styled_components_default.a.div.withConfig({
...
class Calendar_Calendar extends external_react_default.a.Component {
  constructor(props) {
    ...
    Object(defineProperty["a" /* default */])(this, "lastMonth", () => {
    ...
    Object(defineProperty["a" /* default */])(this, "nextMonth", () => {
  ...
  renderHeadings() {
    ...
    return days.map(day => Calendar_jsx(DayHeading, {
      key: day
    }, day));
  }
  ...
  renderInitialDates() {
    ...
    const firstDayOfMonth = external_moment_default()().subtract(day, 'days').add(1, 'day');
    const startDateDay = firstDayOfMonth.day();
    const endDate = external_moment_default()().endOf('month');
    let startDate;
  ...
  getDisplayDates(date) {
    const dates = [];
    let startDate = external_moment_default()(date);
    ...
    for (let i = 0; i <= 34; i++) {
      let offSet = external_moment_default()(startDate);
  ...
  render() {
    return Calendar_jsx(external_react_["Fragment"], null, Calendar_jsx(HeaderContainer, null, Calendar_jsx(HeaderItem, null, Calendar_jsx(CommonButton["a" /* default */], {
      text: "Previous",
      onClick: this.lastMonth
    })), Calendar_jsx(HeaderItem, null, Calendar_jsx("h2", null, this.state.currentMonth)), Calendar_jsx(HeaderItem, null, Calendar_jsx(CommonButton["a" /* default */], {
      text: "Next",
      onClick: this.nextMonth
    }))), Calendar_jsx(CalendarContainer, null, this.renderHeadings(), this.state.dates.map(day => Calendar_jsx(Calendar_CalendarTile, null, day.format('DD')))));
  }
...
// CONCATENATED MODULE: ./pages/dashboard/reservations.js

var reservations_jsx = external_react_default.a.createElement;
...
class reservations_Reservations extends external_react_["Component"] {
  ...
  render() {
    return reservations_jsx(layouts["a" /* default */], null, reservations_jsx(head_default.a, null, reservations_jsx("title", null, "Reservations | Promptli")), reservations_jsx(common_Calendar, null));
  }

}

Object(defineProperty["a" /* default */])(reservations_Reservations, "defaultProps", {});
...
/* harmony default export */ var reservations = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Object(withAuth["a" /* default */])(reservations_Reservations)));
